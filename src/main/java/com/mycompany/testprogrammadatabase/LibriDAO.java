...
public interface LibriDAO {
    ...
    void editLibri(Connection conn, int isbnOld, int isbnNew, String titolo, String casaeditrice, int idAutore, int numeroPagine, String lingua, String genere, double prezzo);
